...
mixin _$VendasStore on _VendasStoreBase, Store {
  ...
  String get vendasDiaValor =>
      (_$vendasDiaValorComputed ??= Computed<String>(() => super.vendasDiaValor,
          ...
          .value;
  Computed<String>? _$vendasMesValorComputed;

  @override
  String get vendasMesValor =>
      (_$vendasMesValorComputed ??= Computed<String>(() => super.vendasMesValor,
              name: '_VendasStoreBase.vendasMesValor'))
          .value;
  Computed<String>? _$vendasAnoValorComputed;
